...
struct libfdata_internal_btree
{
	...
	/* A callback function hook for retrieving leaf btree values (data definitions)
	*/
	int(*report_leaf_value_data_definition)(
...
typedef struct libesedb_key_btree libesedb_key_btree_t;

struct libesedb_key_btree
{
	/* The type
	*/
	uint8_t type;
